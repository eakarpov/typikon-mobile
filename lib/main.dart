...
Future<void> main() async {
  ...
  // Пуши поднимаем до магазина состояния, но не ждём от них ничего: не
  ...
  // бы получать пуши без единой ошибки на экране.
  //
...
/// обработчика нажатий затирает тот, что поставил `main()`, — а пуш при
...
/// суток, и «показывать ли имена». Пуш их не обходит — он только приходит
/// вовремя.
@pragma('vm:entry-point')
