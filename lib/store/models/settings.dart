...
class Settings {
  ...
  /// Android не отдаёт пушей вовсе, и обойти это нельзя.
  ///
  /// Имена при этом не ездят ни в том, ни в другом случае: пуш пуст, а что
  ...
  static Settings fromJson(Map<String, dynamic> json) {
    ...
    return Settings(
      ...
      // Умолчание — приложение: пуши требуют и сети, и живого ключа доставки,
