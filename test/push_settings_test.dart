...
// этом: пуш не пришёл — и тишина.

void main() {
  test("умолчание — приложение", () {
    // Пуши требуют разрешения, сети и живого ключа доставки. Включаться сами,
  ...
  test("состояние прежней версии остаётся за приложением", () {
    // Обновившийся не должен молча оказаться на пушах, которых он не просил
  ...
  test("сброс цветов чтения источника не трогает", () {
    ...
    // вернулось бы к умолчанию — то есть сброс цветов выключил бы пуши.
